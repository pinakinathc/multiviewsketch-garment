...
class Network(nn.Module):
    def __init__(self, point_pos_size=3, output_dim=1, n_z_cut=12):
        ...
        self.fc0 = nn.utils.weight_norm(nn.Conv1d(512 + n_z_cut, 312, kernel_size=1, bias=True))
    ...
    def forward(self, uvmap_representation, point_position):
        ...
        # print ('Points region: points_min: {}, points_max: {}'.format(
        #     torch.min(point_position, dim=1), torch.max(point_position, dim=1)))
