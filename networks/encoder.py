# -*- coding: utf-8 -*-
# Reference: https://github.com/shunsukesaito/PIFu/blob/master/lib/net_util.py#L352
...
class HGFilter(nn.Module):
    def __init__(self, num_stack, norm, hg_down, num_hourglass, hourglass_dim):
...
if __name__ == '__main__':
    print ('Testing data flow of encoder network')
    net = HGFilter(num_stack=4, norm='group', hg_down='ave_pool', num_hourglass=2, hourglass_dim=256)

    _B = 3
    inp = torch.randn(_B, 3, 256, 256)
    out = net(inp)[0]
